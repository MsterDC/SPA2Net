...
source activate
conda activate shuwei

cd /nfs/volume-92-1/shuweidong_i/dsw/SPA-Net-main/SPA-Net-main/exper


/nfs/volume-315-5/frameworks/miniconda3/envs/shuwei/bin/python  /nfs/volume-92-1/shuweidong_i/dsw/SPA-Net-main/SPA-Net-main/exper/train_sst.py \
    --arch=vgg_sst \
    --dataset=ilsvrc \
    ...
    --log_dir=../log/ilsvrc/vgg16_sos+sa_v3_wp_#37 \
    --load_finetune=True \
