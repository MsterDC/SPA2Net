...
def train(args):
    ...
    if 'sos' not in args.mode and not args.ram:
        batch_time, losses, top1, top5, log_head = log_meters
    elif 'sos' in args.mode and not args.ram:
        batch_time, losses, top1, top5, losses_so, log_head = log_meters
    elif 'sos' not in args.mode and args.ram:
        batch_time, losses, top1, top5, losses_ra, log_head = log_meters
    else:
        batch_time, losses, top1, top5, losses_so, losses_ra, log_head = log_meters
    ...
    while current_epoch < total_epoch:
        ...
        for idx, dat in enumerate(train_loader):
            ...
            loss_val, loss_ra, loss_so = model.module.get_loss(logits, label, pred_sos, gt_scm, epoch=current_epoch)
